...
<html style="height:100%">
    ...
    <body style="height:100%; display:flex">
        <img id="profile-img" class="floating interactive" src="../public/mainprofile.jpg" alt="Anderson Yeakey's Profile Picture" fetchpriority="high" style="top: 50%; left: 50%; width:30vh; border-radius: 50%; border: 4px solid black;">
